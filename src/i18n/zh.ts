...
export const zh: Strings = {
  ...
  cookies: {
    ...
    message:
      "我们使用 Google Analytics Cookie 来了解访问情况并改进 Skull Ledger。",
    decline: "拒绝",
    accept: "接受",
  },
  ...
  home: {
    ...
    tableHint: (name) =>
      name
        ? `你在这里计分的对局会保存到「${name}」牌桌。牌桌上的所有成员共享同一份对局记录和同一个排行榜。`
  ...
  whatsNew: {
    ...
    items: [
      "从屏幕边缘滑动即可返回。",
      "你的牌桌现在会说明对局保存在哪里，以及所有成员共享哪些内容。",
      "设置和统计页面的顶部栏会在滚动时保持贴合顶部。",
      "添加新玩家后，姓名输入框会立即准备好输入。",
      "战利品联盟现在位于“无人赢得的墩”区域正上方。",
    ],
    historyTitle: "历史版本",
    history: {
      "1.13.1": [
  ...
  settings: {
    ...
    install: {
      ...
      installedBody: "Skull Ledger 已安装到你的设备上。它像普通应用一样打开，并可完全离线使用。",
      promptHint: "将 Skull Ledger 添加到主屏幕，一触即达并可离线游戏。",
      manualHint:
        "将 Skull Ledger 添加到主屏幕，一触即达并可离线游戏。请按下方对应你手机的步骤操作。",
      button: "立即安装",
  ...
  results: {
    ...
    review: "逐回合查看",
    rematch: "与同一队伍再来一局",
    installTitle: "把 Skull Ledger 留在船上",
